...
function TermsConditionsModal({showTermsCondition, setShowTermsCondition}) {
    if(showTermsCondition === false) {
        return
    }

  return (
     <div className={showTermsCondition ? 'modal fade show' : "modal fade " }>
        <div class="modal-dialog  modal-big">
            <div class="modal-content">
                
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Terms and Conditions</h1>
                    <button onClick={() => setShowTermsCondition(false)} type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"  onClick={() => setShowTermsCondition(false)}>Close</button>
                </div>
            </div> 
        </div>
    </div>
